  ...
  <Pane>
    <Ul>
      <Li>
        ...
        <ExternalLink href='https://www.google.com/maps/place/Brigham+Young+University-Idaho/@43.814414,-111.7854437,17z/data=!3m1!4b1!4m5!3m4!1s0x53540b03dc48a5cf:0x1e5534d3c38ef412!8m2!3d43.8144101!4d-111.783255'>
          アイダホ州レックスバーグ
        </ExternalLink>
      </Li>
      <Li><span className='font-bold'>合格率</span>: <Digit>{SchoolData.byui.acceptanceRate * 100}</Digit>%</Li>
      <Li><span className='font-bold'>学生数</span>: <Digit>{SchoolData.byui.numberOfStudents}</Digit></Li>
      <Li><span className='font-bold'>専攻数</span>: <Digit>{SchoolData.byui.numberOfMajors}</Digit></Li>
      <Li><span className='font-bold'>授業数</span>: <Digit>{SchoolData.byui.numberOfCourses}</Digit></Li>
     </Ul>
  </Pane>
</SplitPane>
