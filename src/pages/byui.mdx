...
import byuiClassImage from '@p/byui/byui_class.png';
import byuiHousingImage from '@p/byui/byui_housing.png';
import byuiFitnessImage from '@p/byui/byui_fitness.png';
