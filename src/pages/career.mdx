...
<UlCol>
  <section>
    <H3 className='inline-block md:-mx-6 lg:-mx-12'>IT</H3>
    <Ul>
      <Li>Amazon</Li>
      <Li>Booking.com</Li>
      <Li>IBM</Li>
  ...
  <section>
    <H3 className='inline-block md:-mx-6 lg:-mx-12'>コンサルティング</H3>
    <Ul>
      <Li>Bain &amp; Company</Li>
      <Li>A.T. Kearney</Li>
    </Ul>
  ...
  <section>
    <H3 className='inline-block md:-mx-6 lg:-mx-12'>会計</H3>
    <Ul>
      <Li>Deloitte</Li>
      <Li>EY</Li>
      <Li>KPMG</Li>
  ...
  <section>
    <H3 className='inline-block md:-mx-6 lg:-mx-12'>金融</H3>
    <Ul>
  ...
  <section>
    <H3 className='inline-block md:-mx-6 lg:-mx-12'>その他</H3>
    <Ul>
