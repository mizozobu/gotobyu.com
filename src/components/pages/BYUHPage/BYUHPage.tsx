        ...
        <Pane className='flex flex-col justify-center py-8 md:py-0'>
          <ul>
            <li className='py-2'>
              ...
              <ExternalLink href='https://www.google.com/maps/place/Brigham+Young+University–Hawaii/@21.6422134,-157.9284008,17z/data=!3m1!4b1!4m5!3m4!1s0x7c004568593757b1:0x5b5ff11727fa5a83!8m2!3d21.6422084!4d-157.9262121'>
                ハワイ州ライエ
              </ExternalLink>
            </li>
            <li className='py-2'>
              <strong className='font-bold'>合格率</strong> :{' '}
              <Digit>{SchoolData.byuh.acceptanceRate * 100}</Digit>%
            </li>
            <li className='py-2'>
            ...
            <li className='py-2'>
              ...
              <Digit>{SchoolData.byuh.numberOfCourses}</Digit>
            </li>
          </ul>
        </Pane>
      </SplitPane>
